  ...
  <section>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <form action="inquiryInsert.do" method="post" enctype="Multipart/form-data" class="form-inline">
          <!--select-->
          <label>문의선택</label>
          <select class="custom-select my-1 mr-sm-2" id="none" style="margin-left: 2rem; width: 25rem;" name="inquiryCode">
   ...
   <!-- 내용 -->
      ...
      <div class="col-3">
        ...
        <textarea id="summernote" name="boardContent" style="margin-left:3rem">
        </textarea>
        </div>
