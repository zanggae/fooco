...
<body>
  ...
  <div class="container">
    ...
    <div style="text-align: center;">
      ...
      <h3>마이리스트 만들기</h3>
      <br><br>
      <form id="mylistRegist" action="mylistRegist.do" method="get">
        <div class="form-group row" style="margin-left: 8rem; font-size: 1.2rem;">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" style="width: 35rem; border:1px solid black; box-shadow: none;"  name="mlTitle">
          </div>
        </div>
    ...
    <div class="row row-cols-2" style="text-align: center;">
      ...
      <div class="col-4" style="margin-left: 4rem;">
        ...
        <div style="height : 40rem; overflow-y : auto;">  
        	<c:url var="mylistRegist" value="mylistRegist.do">
             <c:param name="searchRes" value="${searchRes }"/>
             </c:url>
           <c:if test="${empty searchRes }">
           <br><br>  
           	<h6>음식점을 검색해 음식점을 추가해주세요.</h6>
           </c:if>
            
          
           <c:if test="${!empty searchRes }">
           <c:forEach var="ml" items="${mylist }">
           <c:url var="mylistplus" value="mylistplus.do">
           <c:param name="mlId1" value="${mlId }"/>
           </c:url>
