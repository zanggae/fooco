              ...
              <div class="col-3">
                ...
                <label>&nbsp;&nbsp;제목</label>
                  <input type="text" class="form-control" id="none"
                    placeholder="제목을 입력하세요" style="margin-left: 3.4rem; width: 25rem; margin-top: -0.3rem;">
          </div>
          ...
          <div class="row" style="margin-top: 2rem;">
            ...
            <div class="row mt-2" id="file1" class="fileput" style=>
               ...
               <div class="col-md-6 form-group form_file"
                  ...
                  <input type="text" id="inquiryFile"
                     ...
                     style="position:absolute; opacity: 0;"  onchange="javascript: document.getElementById('inquiryFile').value = this.value">
