...
public class Following implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1525049800670996793L;
	...
	public Following(int memberId, String nickName, String renameName, int followerCount, int followingCount) {
		super();
	...
	public String toString() {
		return "Following [memberId=" + memberId + ", nickName=" + nickName + ", renameName=" + renameName
